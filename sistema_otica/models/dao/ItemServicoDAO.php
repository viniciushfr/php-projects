...
class ItemServicoDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM ItemServico $add";
        //echo $sql;
        return $this->selectDB($sql,null,'ItemServico');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO ItemServico $fields VALUES ($numparams)";
    ...
    public function update($fields,$params=null,$where=null){
        ...
        $sql = "UPDATE ItemServico SET $fields_T";
