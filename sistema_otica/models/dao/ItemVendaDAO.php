...
class ItemVendaDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM ItemVenda $add";
        //echo $sql;
        return $this->selectDB($sql,null,'ItemVenda');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO ItemVenda $fields VALUES ($numparams)";
    ...
    public function update($fields,$params=null,$where=null){
        ...
        $sql = "UPDATE ItemVenda SET $fields_T";
