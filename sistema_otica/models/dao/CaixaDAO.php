...
class CaixaDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM Caixa $add";
        //echo $sql;
        return $this->selectDB($sql,null,'Caixa');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO Caixa ($fields) VALUES ($numparams)";
