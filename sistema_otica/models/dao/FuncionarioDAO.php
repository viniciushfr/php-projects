...
class FuncionarioDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM Funcionario $add";
        //echo $sql;
        return $this->selectDB($sql,null,'Funcionario');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO Funcionario ($fields) VALUES ($numparams)";
    ...
    public function update($fields,$params=null,$where=null){
        ...
        $sql = "UPDATE Funcionario SET $fields_T";
