...
class PagamentoDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM Pagamento $add";
        //echo $sql;
        return $this->selectDB($sql,null,'Pagamento');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO Pagamento $fields VALUES ($numparams)";
        //echo $sql;
    ...
    public function update($fields,$params=null,$where=null){
        ...
        $sql = "UPDATE Pagamento SET $fields_T";
