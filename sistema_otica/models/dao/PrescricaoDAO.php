...
class PrescricaoDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM Prescricao $add";
        //echo $sql;
        return $this->selectDB($sql,null,'Prescricao');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO Prescricao ($fields) VALUES ($numparams)";
    ...
    public function update($fields,$params=null,$where=null){
        ...
        $sql = "UPDATE Prescricao SET $fields_T";
