...
class OrdenServicoDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM OrdenServico $add";
        //echo $sql;
        return $this->selectDB($sql,null,'OrdenServico');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO OrdenServico $fields VALUES ($numparams)";
    ...
    public function update($fields,$params=null,$where=null){
        ...
        $sql = "UPDATE OrdenServico SET $fields_T";
