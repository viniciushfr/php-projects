...
class ItemCompraDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM ItemCompra $add";
        //echo $sql;
        return $this->selectDB($sql,null,'ItemCompra');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO ItemCompra $fields VALUES ($numparams)";
    ...
    public function update($fields,$params=null,$where=null){
        ...
        $sql = "UPDATE ItemCompra SET $fields_T";
