...
class VendaDAO extends database{
    ...
    public function load($fields="*",$add=""){
        ...
        $sql = "SELECT $fields FROM Venda $add";
        //echo $sql;
        return $this->selectDB($sql,null,'Venda');
    }
    ...
    public function insert($fields,$params=null){
        ...
        $sql = "INSERT INTO Venda $fields VALUES ($numparams)";
